...
{	category= 'Global', 	subcategory= 'Song', 	event_type= 'param', 	id= 'crow_clock_index', 	name= 'Crow clock', 	value_type= 'continuous', 	formatter= 'crow_clock_string', 	action= 'set_crow_clock', 		},
										
-- Chord										
{	category= 'Chord', 	subcategory= 'Pattern', 	event_type= 'function', 	id= 'transpose_chord_pattern', 	name= 'Transpose', 	value_type= 'discreet', 				},
{	category= 'Chord', 	subcategory= 'Voice', 	event_type= 'param', 	id= 'chord_dest', 	name= 'Destination', 	value_type= 'continuous', 		action= 'update_menus', 		},
...
{	category= 'Chord', 	subcategory= 'Voice', 	event_type= 'param', 	id= 'chord_div_index', 	name= 'Step length', 	value_type= 'continuous', 	formatter= 'divisions_string', 	action= 'set_div', 	action_var= 'chord', 	},
{	category= 'Chord', 	subcategory= 'Voice', 	event_type= 'param', 	id= 'chord_duration_index', 	name= 'Duration', 	value_type= 'continuous', 	formatter= 'divisions_string', 	action= 'set_duration', 	action_var= 'chord', 	},
...
{	category= 'Arp', 	subcategory= 'Pattern', 	event_type= 'function', 	id= 'rotate_arp', 	name= 'Rotate', 	value_type= 'discreet', 				},
{	category= 'Arp', 	subcategory= 'Pattern', 	event_type= 'function', 	id= 'transpose_arp_pattern', 	name= 'Transpose', 	value_type= 'discreet', 				},
{	category= 'Arp', 	subcategory= 'Voice', 	event_type= 'param', 	id= 'arp_dest', 	name= 'Destination', 	value_type= 'continuous', 		action= 'update_menus', 		},
...
{	category= 'Arp', 	subcategory= 'Voice', 	event_type= 'param', 	id= 'arp_div_index', 	name= 'Step length', 	value_type= 'continuous', 	formatter= 'divisions_string', 	action= 'set_div', 	action_var= 'arp', 	},
{	category= 'Arp', 	subcategory= 'Voice', 	event_type= 'param', 	id= 'arp_duration_index', 	name= 'Duration', 	value_type= 'continuous', 	formatter= 'divisions_string', 	action= 'set_duration', 	action_var= 'arp', 	},
...
{	category= 'Arp', 	subcategory= 'Crow', 	event_type= 'param', 	id= 'arp_tr_env', 	name= 'Output', 	value_type= 'continuous', 		action= 'update_menus', 		},
...
-- MIDI harmonizer										
{	category= 'MIDI harmonizer', 	subcategory= 'Voice', 	event_type= 'param', 	id= 'midi_dest', 	name= 'Destination', 	value_type= 'continuous', 		action= 'update_menus', 		},
...
{	category= 'MIDI harmonizer', 	subcategory= 'Voice', 	event_type= 'param', 	id= 'midi_duration_index', 	name= 'Duration', 	value_type= 'continuous', 	formatter= 'divisions_string', 	action= 'set_duration', 	action_var= 'midi', 	},
...
{	category= 'MIDI harmonizer', 	subcategory= 'MIDI', 	event_type= 'param', 	id= 'do_midi_velocity_passthru', 	name= 'Pass velocity', 	value_type= 'continuous', 	formatter= 't_f_string', 	action= 'update_menus', 		},
...
{	category= 'MIDI harmonizer', 	subcategory= 'Crow', 	event_type= 'param', 	id= 'midi_tr_env', 	name= 'Output', 	value_type= 'continuous', 		action= 'update_menus', 		},
...
-- CV harmonizer										
{	category= 'CV harmonizer', 	subcategory= 'Voice', 	event_type= 'param', 	id= 'crow_dest', 	name= 'Destination', 	value_type= 'continuous', 		action= 'update_menus', 		},
...
{	category= 'CV harmonizer', 	subcategory= 'Voice', 	event_type= 'param', 	id= 'crow_duration_index', 	name= 'Duration', 	value_type= 'continuous', 	formatter= 'divisions_string', 	action= 'set_duration', 	action_var= 'crow', 	},
...
{	category= 'CV harmonizer', 	subcategory= 'Crow', 	event_type= 'param', 	id= 'crow_tr_env', 	name= 'Output', 	value_type= 'continuous', 		action= 'update_menus', 		},
