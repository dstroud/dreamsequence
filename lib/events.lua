...
{	category= 'Seq', 	subcategory= 'Voice', 	event_type= 'param', 	id= 'seq_mode_1', 	name= 'Mode', 	value_type= 'continuous', 				},
...
{	category= 'Seq', 	subcategory= 'Crow', 	event_type= 'param', 	id= 'seq_ad_skew_1', 	name= 'AD Skew', 	value_type= 'continuous', 				},
{	category= 'Seq', 	subcategory= 'JF', 	event_type= 'param', 	id= 'seq_jf_amp_1', 	name= 'Amp', 	value_type= 'continuous', 				},
{	category= 'Seq', 	subcategory= 'Disting', 	event_type= 'param', 	id= 'seq_disting_velocity_1', 	name= 'Velocity', 	value_type= 'continuous', 				},
										
-- MIDI harmonizer										
{	category= 'MIDI harmonizer', 	subcategory= 'Style', 	event_type= 'param', 	id= 'midi_note_map', 	name= 'Notes', 	value_type= 'continuous', 				},
...
-- CV harmonizer										
{	category= 'CV harmonizer', 	subcategory= 'Style', 	event_type= 'param', 	id= 'crow_note_map', 	name= 'Notes', 	value_type= 'continuous', 				},
