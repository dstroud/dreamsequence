...
{	category= 'Chord', 	subcategory= 'Voice', 	event_type= 'param', 	id= 'chord_polyphony', 	name= 'Polyphony', 	value_type= 'continuous', 				},
{	category= 'Chord', 	subcategory= 'Voice', 	event_type= 'param', 	id= 'chord_spread', 	name= 'Spread', 	value_type= 'continuous', 	formatter= 'plus_string', 			},
